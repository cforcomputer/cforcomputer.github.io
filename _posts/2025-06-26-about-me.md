...
• Developed a Python‑based bot using Playwright, scrapy, and proxies with Airflow for an AI pricing system, automating competitor data collection and price recommendations across 100,000 products. This reduced manual processing time by 91%.
...
• Prototyped customer gifts using Onshape CAD, 3D printing, circuit prototyping and Arduino with esp32.
