...
<video autoplay loop controls muted playsinline preload="metadata" poster="{{ '/assets/images/projects/itemfinder-svelte.png' | relative_url }}" style="max-width: 100%; height: auto;">
